    ...
    >
      ...
      <div className="flex flex-col justify-between h-[calc(100%-4rem)]">
        ...
        <div className="p-4 space-y-1">
          ...
          <button className="flex w-full items-center space-x-2 rounded-lg px-3 py-2 text-white/80 transition-colors hover:bg-white/10 hover:text-white">
        ...
        <div className="p-4 border-t border-white/10">
          <div className="flex items-center space-x-3">
            <Avatar className="h-10 w-10 border-2 border-white/20">
              ...
              <AvatarFallback className="bg-[#FFD700] text-[#0F172A]">AD</AvatarFallback>
            </Avatar>
            <div>
              <p className="text-sm font-medium">Admin User</p>
              <p className="text-xs text-white/60">admin@yabatech.edu.ng</p>
            </div>
          </div>
        </div>
      </div>
